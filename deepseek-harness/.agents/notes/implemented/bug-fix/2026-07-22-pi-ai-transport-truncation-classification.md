...
- `classifyPiAiError` recognizes transport wordings and maps them to `TRANSPORT`:
  ...
  - OpenAI Codex WebSocket failures surfaced as `WebSocket error`, `WebSocket closed 1006`, or `websocket_connection_limit_reached`.
