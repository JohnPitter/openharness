/**
 * Translate Kimi SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate Kimi wire chunks into the harness `StreamChunk` protocol.
 * @module dsh-llm-kimi/translate
 */
...
/**
 * Map wire usage fields. Kimi's `prompt_tokens` INCLUDES cache hits; the
