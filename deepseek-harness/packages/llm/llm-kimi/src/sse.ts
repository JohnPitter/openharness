 ...
 * chat-completions protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module dsh-llm-kimi/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@deepseek-ai/dsh-llm'

/** The terminal payload Kimi (and OpenAI) send after the last chunk. */
