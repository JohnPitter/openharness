...
describe('OpenHarness shipped catalog routes', () => {
  it('resolves coding-plan routes with the composition profiles', () => {
    const resolved = resolveProfiles({
      'claude-code': {
    ...
    expect(resolved.get('claude-code')?.piProvider.auth.apiKey).toBeDefined()
