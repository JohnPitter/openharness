...
| `foregroundWait` | Whether this instance may wait in the foreground, default `allowed`. `never` omits `run_in_background`, always takes the background route, and ignores an extra `false`; requires background execution. |
