...
import { en, es, NS, pt, zh, type SessionLogDownloadKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en, pt, es }), 'session-log-download: browser dictionaries')
