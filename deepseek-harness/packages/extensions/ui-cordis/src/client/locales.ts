...
export const pt = {
  ...
  'render.failedAbdicated': 'Falha ao renderizar em {slot}; a UI padrão foi restaurada:',
...
export const es = {
  ...
  'render.failedAbdicated': 'Error al renderizar en {slot}; se restauró la UI predeterminada:',
  'render.failedHeld': 'Error al renderizar en {slot}:',
  'a11y.defining': 'Definiendo el plugin',
  'a11y.failed': 'Definición fallida',
