...
The gateway refuses only while a turn is in flight ([`dsh-apiproxy`](../../host/apiproxy/README.md) answers `agent-preset-locked`). Historical tool calls stay in the log; later turns use the new composition.
