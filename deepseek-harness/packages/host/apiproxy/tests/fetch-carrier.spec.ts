  ...
  return {
    sessions: {
      ...
      async delete(request) {
        return {
          rpcId: request.rpcId,
          result: { ok: true, value: { deleted: true as const, sessionIds: [request.payload.sessionId] } },
        }
      },
    },
    subagents: {
    ...
    llm: {
      ...
      async accountUsage(request) {
        return { rpcId: request.rpcId, result: { ok: true, value: { supported: false } } }
      },
    },
    events: {
