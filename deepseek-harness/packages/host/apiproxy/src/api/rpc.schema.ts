...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('session-active'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('revision-anchor-stale'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('revision-anchor-not-latest'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('revision-incomplete-turn'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('revision-uncertain'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
