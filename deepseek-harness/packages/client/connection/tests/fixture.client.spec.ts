      ...
      events: [], hasMore: false, projections: { asOfSeq: -1, values: {
        ...
        permissions: {
          options: [
            ...
            { value: 'danger-full-access', name: 'danger-full-access', description: 'Full file, process, and host access without approval prompts, including privileged operations.' },
          ],
