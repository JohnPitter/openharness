...
export const pt = {
  ...
  'access.confirm.description': 'O Full access reduz as etapas de confirmação e permite que o agente execute mais ações diretamente, incluindo operações sensíveis, alterações de arquivos ou comandos externos. Use apenas quando você confia na tarefa atual.',
...
export const es = {
  ...
  'access.confirm.title': '¿Activar Full access?',
  'access.confirm.description': 'Full access reduce los pasos de confirmación y permite al agente realizar más acciones directamente, incluidas operaciones sensibles, cambios de archivos o comandos externos. Úsalo solo cuando confíes en la tarea actual.',
  'access.confirm.acknowledge': 'Entiendo los riesgos y quiero continuar',
  'access.confirm.cancel': 'Cancelar',
  'access.confirm.enable': 'Activar Full access',
  'hero.headline': 'OpenHarness',
