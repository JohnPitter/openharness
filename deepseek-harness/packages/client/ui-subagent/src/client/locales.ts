...
export const pt: Record<SubagentKey, string> = {
  ...
  'switcher.aria': 'Trocar subagente: {title}',
  ...
  'readonly.oneShot.body': 'Tarefas de execução única não aceitam mensagens subsequentes; veja o registro completo da execução aqui.',
...
export const es: Record<SubagentKey, string> = {
  ...
  'readonly.oneShot.body': 'Las tareas de un solo uso no aceptan mensajes posteriores; consulta el registro completo de la ejecución aquí.',
