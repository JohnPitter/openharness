 ...
 * on a shipped catalog route means "serve this route's built-in catalog" (so
 * the selector still lists those models); any entry replaces that catalog, so
 * a row is only ever added deliberately. Fetching asks the endpoint
