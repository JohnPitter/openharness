...
import { en, es, pt, zh, type CommonKey } from '../locales/index.ts'
import {
  en as settingsEn, es as settingsEs, pt as settingsPt, zh as settingsZh, type SettingsLocaleKey,
 ...
 */
const DOCUMENT_LANGUAGE: Record<LocaleId, string> = { zh: 'zh-CN', en: 'en', pt: 'pt-BR', es: 'es' }
...
export function apply(ctx: ClientContext): void {
  ...
  locale.register(COMMON_NS, { zh, en, pt, es })
  locale.register(SETTINGS_NS, { zh: settingsZh, en: settingsEn, pt: settingsPt, es: settingsEs })
