...
import { en, es, pt, zh, type SettingsKey } from './locales.ts'
 ...
 */
export const inject = ['slots', 'locale', 'connection', 'settingsScope', 'settingsNav']
...
export function apply(ctx: ClientContext): void {
  ctx.effect(() => ctx.locale.register(NS, { zh, en, pt, es }), 'ui-settings-general: dictionaries')
  ...
  const shellInjected = (): SettingsRootInjected => ({
    ...
    bindNavigation: handler => ctx.settingsNav.bind(handler),
    hooks: {
