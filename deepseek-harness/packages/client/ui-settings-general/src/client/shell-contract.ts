...
export type SettingsRootInjected = {
  /** Request a fresh logical generation and physical streams immediately. */
  reconnect: () => void
  hooks: {
  ...
  /**
   * Bind this shell's open-section callback to `ctx.settingsNav` so other
   * features can open a page without importing the occupant.
   */
  bindNavigation: (openSection: (id: string) => void) => () => void
}
