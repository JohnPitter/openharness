...
export const pt = {
  ...
  presetProvidedDetail: 'Desativado globalmente; presets de agente o fornecem por sessão',
...
export const es = {
  ...
  presetSubtitle: 'Compuestos por sesión por los presets de agente',
  countUnit: 'plugins',
  switcherLabel: 'Elija el preset de agente a inspeccionar',
  ...
  presetProvidedDetail: 'Desactivado globalmente; los presets de agente lo proporcionan por sesión',
  enabledIn: 'Activado en',
  viewInPreset: 'Ver en el grupo del preset',
  matchesInOtherPresets: '{count} coincidencias más en otros presets: ',
  failedCountLabel: 'con error',
  enabledTag: 'Activado',
  disabledTag: 'Desactivado',
  conditionalTag: 'Condicional',
  presetEnabledTag: 'Activado vía presets',
  failedTag: 'Falló',
  moduleLabel: 'Módulo',
  fromPreset: 'De',
