...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsNav: 'client-side settings-shell navigation service — packages/client/ui-settings/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmMetering: 'llm-streaming.md',
  LlmAccountUsage: 'llm-streaming.md',
  LlmAccountUsageWindow: 'llm-streaming.md',
