...
| **Marcos** | O modelo que fecha o trabalho grava um marco; o trilho à esquerda salta até ele e se adapta a telas estreitas. |
...
wails build -ldflags "-X openharness/internal/update.Version=0.1.18"
go test ./...
```
...
gh release upload v0.1.18 build/bin/openharness.exe
```
